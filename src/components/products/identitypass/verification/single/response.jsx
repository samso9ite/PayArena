...
const individual_channel = {
    ...
    DV_NIN: 'National Identity Number',
    ALIEN_KE: "Alien ID"
}
                                ...
                                return (
                                    ...
                                    v[0] !== 'base64Image' && (
                                        ...
                                        Object.entries(v[1]).map(newVal => (
                                            <View key={newVal[0]}>
                                                <Text style={{fontSize:'8px', marginTop:"1%", marginBottom: "0.5%"}} >{getKeyLabel(newVal[0])}</Text><br />
                                                {(typeof newVal[1] === "object") ?
                                                    Object.entries(newVal[1]).map(innerNewVal => (
                                                        <View key={innerNewVal[0]} style={styles.test_two}>
                                                            <Text style={styles.company_details_subtitle_right_two}>{getKeyLabel(innerNewVal[0])?.replace(
                                                                        /_/g,
                                                                        ' '
                                                                    )}
                                                            </Text>
                                                            {
                                                                (typeof innerNewVal[1] === "object") ?
                                                                    Object.entries(innerNewVal[1]).map(innerChildVal => (
                                                                        <View key={innerChildVal[0]}  style={[styles.test_two, {flexDirection:'row'}]}>
                                                                            ...
                                                                            {Array.isArray(innerChildVal[1]) ?  
                                                                                    ...
                                                                                    Object.entries(value).map(([key, newValUp]) => (
                                                                                        <View key={newValUp[0]} >
                                                                                            <Text style={styles.company_details_subtitle_right_two}>{newValUp[1]}</Text>
                                                                                        </View>
                                                                                        ))
                                                                                    ))
                                                                                : 
                                                                                 (typeof innerChildVal[1] === "object") ? Object.entries(innerChildVal[1]).map(deepNextedVal => (
                                                                                    <View key={deepNextedVal[0]} >
                                                                                        
                                                                                            <Text  style={{fontSize:"8px"}}>
                                                                                                {getKeyLabel(deepNextedVal[0])} : {deepNextedVal[1] }
                                                                                            </Text>
                                                                                    </View>
                                                                                        ))
                                                                                    :
                                                                                    <View > 
                                                                                        <Text style={styles.company_details_subtitle_right_two}> {innerChildVal[1]}</Text> 
                                                                                        </View>
                                                                                    } 
                                                                            </View>
                                                                    ))
                                                                :   <View > 
                                                                        <Text style={styles.company_details_subtitle_right_two}>{innerNewVal[1]}</Text>
                                                                    </View>
                                                            }
                                                        </View>
                                                    ))
                                                    : <View  style={[styles.test_two, {flexDirection:'row'}]}> 
                                                        <Text style={styles.company_details_subtitle_right_two}>{newVal[1]}</Text>
                                                     </View>
                                                }
                                            </View>
                                        ))
                                        :
                                        <View key={v[0]}  style={[styles.test_two, {flexDirection:'row'}]}>
                                             <Text style={styles.company_details_subtitle_right_two}>
                                                {v[0]}
                                            </Text>
            ...
            <View style={styles.topHeader_container}>
                <View style={styles.topHeader}>
                    ...
                    <Text style={styles.headerText_alt}>
                        {idData?.name || idData?.company || idData?.company_name || idData[0]?.name || '-'}
                    </Text>
                </View>
            </View>
            <View style={styles.topHeader_container}>
                <View style={styles.topHeader}>
                    ...
                    <Text style={styles.headerText_alt}>{new Date().toDateString()}</Text>
                </View>
            </View>
            </View>
                    ...
                    : Array?.isArray(idData) &&
                      idData.map((v, index) => {
                          return (
                              ...
                              //     </Text>
                              //     <Text style={styles.company_details_subtitle_left}>
                              //       {Object.values ? Object.values(v) : 'Not available'}
                              //     </Text>
                              // </View>
                          )
                          // )
                ...
                <>
                    {
                        <>
                                ...
                                <div className="text-center mt-4" >
                                    ...
                                    {/* {props.channel === 'KENYA_BRS_DETAIL' && (
                                        ...
                                        <PDFDownloadLink
                                            ...
                                            fileName={`${idData?.company || idData?.name}.pdf`}>
                            ...
                            {idData && props?.channel !== 'ADDRESS_NG' && 
                            ...
                            props?.channel !== 'COMPANY_GENERAL_SEARCH' &&
                            ...
                            <div className='row justify-content-between mt-3'>
                                {!openDirectors && idDataKeys?.map((key, index) => {
                                    if (typeof idData[key] !== "object") {
                                        return (
                                            <span className={(index + 1) % 2 === 1 ? "col-md-6 py-1" : "col-md-6 text-md-end"} key={index} style={{ borderBottom: "1px solid #ddd", paddingBottom: "0px", marginBottom: "0px" }}>
                                                {((key !== "photo") && (key !== "Photo") && (key !== "image") && (key !== "DriverImage")&& (key !== "file_base64") && (key !== "base64Image") && (key !== "signature") && (key !== "directors") && (key !== "expirationDate") && (key !== "service_provider")) &&
                                                    <>
                                                                                                    ...
                                                                                                    Object.entries(idData[key][val][newVal]).map(([key, childVal]) => (
                                                                                                        Array.isArray(childVal) ? 
                                                                                                            Object.entries(childVal).map(([key, value]) => (
                                                                                                              Object.entries(value).map(([key, newVal]) => (
                                                                                                                  <p key={key}>{`${key}: ${newVal}` || "Not Available"}</p>
                                                                                                                    ))
                                                                                                                ))
                                                                                                          : 
                                                                                                        Object.entries(childVal).map(([key, newVal]) => (
                                                                                                            ...
                                                                                                            {getKeyLabel(key)?.replace( /_/g, ' ' )}
                                                                                                                ...
                                                                                                                <p key={key}>{`${newVal}` || "Not Available"}</p>
                                                                                                            </>
                                                                                                        ))
                                                                                                    ))
                                                                                                    :<>
                                                                                                        ...
                                                                                                        <div key={innerKey}>
                                                                                                            ...
                                                                                                            {Array.isArray(innerValue) ?  
                                                                                                              Object.entries(innerValue).map(([key, value]) => (
                                                                                                                Object.entries(value).map(([key, newVal]) => (
                                                                                                                    <p key={key}>{`${key}: ${newVal}` || "Shale"}</p>
                                                                                                                      ))
                                                                                                                  ))
                                                                                                            : 
                                                                                                             <p>{`${JSON.stringify(innerValue).replace(/[\{\}"]/g, "")}` || "Not Available"}</p>
                                                                                                            }
